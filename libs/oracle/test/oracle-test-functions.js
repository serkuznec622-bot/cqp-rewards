...
import { makeOracleInstanceV4 } from "../src/oracle-instance.js";
...
function checkOracle() {
	...
	{
		const oracle = makeOracleInstanceV4();
		const seed = createRandomSeed(2);
...
function checkOracleRepeatability() {
	const salt = v4();
	const oracle1 = makeOracleInstanceV4();
	const seed1 = createRandomSeed(2);

	const oracle2 = makeOracleInstanceV4();
	const seed2 = seed1.copy();
